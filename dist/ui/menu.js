                        ...
                        switch (type) {
                            case '利用規約':
                                ...
                                content = `
                                    ...
                                    <p>当方は本サービスに関し、本規約のほか、各種の規定（以下「個別規定」）をすることがあります。これら個別規定はその名称のいかんに関わらず、本規約の一部を構成するものとします。</p>
                                    <p><strong>第2条（サービスの内容およびデータの管理）</strong></p>
                                    <p>本サービスは、ブラウザ上で動作するフロントエンド完結型の文書エディタです。</p>
                                    <p>本サービスは、ユーザーが入力したデータをサーバー上に保存する機能を有しておりません。データはユーザーのブラウザのローカルストレージまたは端末内にのみ保存されます。</p>
                                    <p>ユーザーは、自己の責任においてデータのバックアップを行うものとします。</p>
                                    <p><strong>第3条（禁止事項） ユーザーは、本サービスの利用にあたり、以下の行為をしてはなりません。</strong></p>
                                    <p>本サービスの運営を妨害するおそれのある行為</p>
                                    <p>本サービスの逆コンパイル、逆アセンブル、リバースエンジニアリング等、ソースコードを解析する行為</p>
                                    ...
                                    <p>本サービスに係るシステムの保守点検または更新を行う場合</p>
                                    <p>サーバーまたは通信回線等が事故により停止した場合</p>
                                    <p>その他、当方が本サービスの提供が困難と判断した場合</p>
                                    <p>当方は、本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害についても、一切の責任を負わないものとします。</p>
                                    <p><strong>第5条（免責事項）</strong></p>
                                    ...
                                    <p><strong>第6条（サービス内容の変更等）</strong> 当方は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。</p>
                                    <p><strong>第7条（利用規約の変更）</strong> 当方は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。</p>
                                    <p><strong>第8条（準拠法・裁判管轄）</strong></p>
                                    <p>本規約の解釈にあたっては、日本法を準拠法とします。</p>
                                    <p>本サービスに関して紛争が生じた場合には、当方の居住地を管轄する裁判所を専属的合意管轄とします。</p>
                                    <p>以上</p>
                                `;
                                break;
                            case 'プライバシーポリシー':
                                ...
                                content = `
                                    ...
                                    <p><strong>第1条（個人情報の収集について）</strong></p>
                                    <p>入力データの非収集: 本サービスは、ユーザーがエディタに入力したテキスト、作成したファイル等のデータをサーバーに送信または保存することはありません。すべての処理はユーザーのブラウザ上（ローカル環境）で完結します。</p>
                                    <p>自動的に収集される情報: サービスの改善および利用状況分析のため、Cookie（クッキー）やGoogleアナリティクス等のアクセス解析ツールを使用し、匿名化されたトラフィックデータを収集することがあります。これには個人を特定する情報は含まれません。</p>
                                    <p><strong>第2条（お問い合わせ情報の管理）</strong> ユーザーからのお問い合わせ時に提供いただいた氏名やメールアドレス等の情報は、お問い合わせへの回答および必要な情報の連絡にのみ利用し、適切に管理いたします。</p>
                                    <p><strong>第3条（個人情報の第三者提供）</strong> 当方は、法令に基づき開示が必要な場合を除き、ユーザーの同意を得ることなく個人情報を第三者に提供することはありません。</p>
                                    <p><strong>第4条（個人情報の安全管理）</strong> 当方は、収集した情報の漏泄、滅失または毀損の防止、その他収集した情報の適切な管理のために必要な措置を講じます。</p>
                                    <p><strong>第5条（プライバシーポリシーの変更）</strong></p>
