                        ...
                        switch (type) {
                            case '利用規約':
                                ...
                                content = `
                                    ...
                                    <p class="section-title"><strong>第3条（禁止事項） ユーザーは、本サービスの利用にあたり、以下の行為をしてはなりません。</strong></p>
                                    ...
                                    <p class="section-title"><strong>第6条（サービス内容の変更等）</strong> 当方は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。</p>

                                    <p class="section-title"><strong>第7条（利用規約の変更）</strong> 当方は、必要と判断した場合には、ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお、本規約の変更後、本サービスの利用を開始した場合には、当該ユーザーは変更後の規約に同意したものとみなします。</p>
                            ...
                            case 'プライバシーポリシー':
                                ...
                                content = `
                                    ...
                                    <p class="section-title"><strong>第2条（お問い合わせ情報の管理）</strong> ユーザーからのお問い合わせ時に提供いただいた氏名やメールアドレス等の情報は、お問い合わせへの回答および必要な情報の連絡にのみ利用し、適切に管理いたします。</p>

                                    <p class="section-title"><strong>第3条（個人情報の第三者提供）</strong> 当方は、法令に基づき開示が必要な場合を除き、ユーザーの同意を得ることなく個人情報を第三者に提供することはありません。</p>

                                    <p class="section-title"><strong>第4条（個人情報の安全管理）</strong> 当方は、収集した情報の漏洩、滅失または毀損の防止、その他収集した情報の適切な管理のために必要な措置を講じます。</p>
