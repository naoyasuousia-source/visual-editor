...
export function CommandApprovalBar({
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9998] bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-2xl animate-in slide-in-from-bottom duration-300">
