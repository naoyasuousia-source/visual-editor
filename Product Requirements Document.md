...
現在、vanilla TSで作られたAI-Link Editor（オリジナルエディタ）をAI-Link Editor v2としてReactで作り直している。
オリジナルエディタのTSにはほぼすべてに機能的な意味があるが、まだ細かい機能・関数が引き継がれていない状態である。
本プロジェクトでは、rules.mdに厳密に従いつつ、機能・関数の引継ぎをすませたのち、さらなる機能向上を目指す。
